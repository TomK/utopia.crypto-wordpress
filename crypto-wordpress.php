...
class uCryptWPCustomHash implements iCrypt {
	public static function CanUse() { return true; }
	public static function CreateSalt() {
		return false; // unused - uses phpAss internal
	}
	public static function Test($string,$digest) {
		return (self::Encrypt($string, $digest) == $digest);
	}
	public static function Encrypt($string,$salt = null) {
		$hasher = new PasswordHash(8, TRUE);
		
		$hash = $hasher->crypt_private($string, $salt);
		if ($hash[0] == '*')
...
uCrypt::RegisterClass('uCryptWPCustomHash');
